...
?>
	...
	<strong><a href="?page=wp_image_refresh_add&id=<?php echo $results->id_pk; ?>"><?php if(!empty($results->slideTitle)){ echo $results->slideTitle; } ?></a></strong><br><div class="row-actions"><span class="edit"><a href="?page=wp_image_refresh_add&id=<?php echo $results->id_pk; ?>">Edit</a></span></div></td>
