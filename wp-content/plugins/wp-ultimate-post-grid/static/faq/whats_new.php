<div class="changelog">
    <div>
        <p class="about-description">We keep working on WP Ultimate Post Grid every single week. Find out what's new in our latest version.</p>
    </div>
    ...
    <div>
        ...
        <ul>
            <li>The very first Premium version of this plugin</li>
        </ul>
        <h4>Core Plugin 1.4</h4>
        <ul>
        ...
        <h4>Core Plugin 1.3</h4>
        <ul>
            <li>Feature: Pagination</li>
        </ul>
        <h4>Core Plugin 1.2</h4>
        <ul>
        ...
        <h4>Core Plugin 1.1</h4>
        <ul>
            <li>Fix: Firefox compatibility</li>
        </ul>
        <h4>Core Plugin 1.0</h4>
        <ul>
            <li>The very first version of this plugin</li>
        </ul>
    </div>
</div>